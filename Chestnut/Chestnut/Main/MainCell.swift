...
//
    ...
    func initContent() {
        ...
        self.content.font = self.content.font.withSize(15)
    ...
    func initCollection() {
        ...
        self.contentView.addConstraint(NSLayoutConstraint(item: self.collection, attribute: .width, relatedBy: .equal, toItem: nil, attribute: .notAnAttribute, multiplier: 1, constant: 200));
        ...
        self.collectionLabel.textColor = #colorLiteral(red: 0.501960814, green: 0.501960814, blue: 0.501960814, alpha: 1)
        self.collectionLabel.font = self.collectionLabel.font.withSize(14)
    ...
    func initCover() {
        ...
        self.contentView.addConstraint(NSLayoutConstraint(item: self.cover, attribute: .top, relatedBy: .equal, toItem: self.contentView, attribute: .top, multiplier: 1, constant: 16 + 24 + 4))
        ...
        self.contentView.addConstraint(NSLayoutConstraint(item: self.cover, attribute: .height, relatedBy: .equal, toItem: nil, attribute: .notAnAttribute, multiplier: 1, constant: 132 - 16 - 16 - 24 - 8))
        self.contentView.addConstraint(NSLayoutConstraint(item: self.cover, attribute: .width, relatedBy: .equal, toItem: nil, attribute: .notAnAttribute, multiplier: 1, constant: 132 - 16 - 16 - 24))
    }
